...
(function() {
  var Commander, Fs, Path, Pg, Postgresql, Utils, async;
  ...
  Postgresql = (function() {
    ...
    Postgresql.prototype.createDatabase = function() {
      ...
      config = this.config;
      using = this.using;
      return Commander.prompt('root user (postgres): ', function(user) {
        if (user == null) {
          user = 'postgres';
        }
        return Commander.password('password: ', function(password) {
          var execRootSql, statements;
