...
(function() {
  var Async, Commander, Fs, Path, Pg, Postgresql, Prompt, Utils, pty,
    __slice = [].slice;
  ...
  Postgresql = (function() {
    ...
    Postgresql.prototype.execFileCLI = function(filename, cb) {
      ...
      command = "psql";
      args = ["-U", this.config.user, "-d", this.config.database, "-h", host, "-p", port, "--file=" + filename, "-1", "--set", "ON_ERROR_STOP=1"];
