...
(function() {
  var Async, Fs, Path, Pg, Postgresql, Prompt, SqlError, Transaction, Utils, nextSavepoint, savepointId, toSqlError,
    __slice = [].slice;
  ...
  nextSavepoint = function() {
    savepointId += 1;
    return "mygrate" + savepointId;
  };
