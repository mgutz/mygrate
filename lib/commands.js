...
(function() {
  var Commands, Fs, Os, Path, Table, Utils, async, cwd, dbInterface, down, errHandler, existsSync, forceDown, getSubDirs, initMigrationsDir, migrationFile, pad2, readMigrationFile, timestamp, _,
    _this = this;
