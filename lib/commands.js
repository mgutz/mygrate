...
(function() {
  var Commands, Fs, Os, Path, Table, Utils, Wrench, async, cwd, dbInterface, down, errHandler, forceDown, getDefaultUser, getSubDirs, initMigrationsDir, migrationFile, pad2, readMigrationFile, timestamp, _,
    _this = this;
  ...
  Commands = {
    ...
    generate: function(argv, vendor) {
      var filename, path, suffix, template;
      suffix = argv._[1];
