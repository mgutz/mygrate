...
(function() {
  var Commands, Fs, Path, async, cwd, dbInterface, down, errHandler, existsSync, forceDown, getSubDirs, initMigrationsDir, migrationFile, pad2, prog, readMigrationFile, timestamp,
    _this = this;
  ...
  initMigrationsDir = function(dbMake) {
    var absPath, sample;
    if (!existsSync("./migrations")) {
    ...
    if (!existsSync("./migrations/config.js")) {
      ...
      return console.log("Created " + dbMake + " sample configuration. Edit migrations/config.js.");
    }
  };
