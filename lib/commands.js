...
(function() {
  var Commands, Fs, Path, async, cwd, dbInterface, down, existsSync, forceDown, getSubDirs, initMigrationsDir, migrationFile, pad2, prog, readMigrationFile, timestamp,
    _this = this;
  ...
  initMigrationsDir = function(dbProduct) {
    var absPath, sample;
    if (typeof dbProduct !== 'string') {
    ...
    if (!existsSync("./migrations/config.js")) {
      ...
      return console.log("Created " + dbProduct + " sample configuration. Edit migrations/config.js.");
    }
  };
