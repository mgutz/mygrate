...
(function() {
  var Commands, Fs, Path, Table, Utils, async, cwd, dbInterface, down, errHandler, existsSync, forceDown, getSubDirs, initMigrationsDir, migrationFile, pad2, prog, readMigrationFile, timestamp,
    _this = this;
  ...
  dbInterface = function() {
    ...
    return {
      ...
      minPrehookDate: (_ref = (_ref1 = config.mygrate) != null ? _ref1.minPrehookDate : void 0) != null ? _ref : "999999999999",
  ...
  Commands = {
    ...
    migrateUp: function(argv) {
      var config, dirs, lastMigration, minPrehookDate, schema, _ref;
      _ref = dbInterface(), schema = _ref.schema, config = _ref.config, minPrehookDate = _ref.minPrehookDate;
      dirs = null;
      lastMigration = null;
      return async.series({
