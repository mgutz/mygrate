...
(function() {
  var Commands, DEFAULT_MINHOOK_DATE, Fs, Os, Path, ProjTemplate, Table, Utils, Wrench, async, cwd, dbInterface, down, errHandler, forceDown, getConfig, getDefaultUser, getEnv, getEnvConfig, getSubDirs, initMigrationsDir, migrationFile, pad2, readMigrationFile, str, timestamp, username, writeConfig, _;
