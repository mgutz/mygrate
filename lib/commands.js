...
(function() {
  var Commands, Fs, Path, Utils, async, cwd, dbInterface, down, errHandler, existsSync, forceDown, getSubDirs, initMigrationsDir, migrationFile, pad2, prog, readMigrationFile, timestamp,
    _this = this;
